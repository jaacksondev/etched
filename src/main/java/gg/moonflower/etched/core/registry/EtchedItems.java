...
public class EtchedItems {
    ...
    public static final DeferredItem<Item> ETCHED_MUSIC_DISC = REGISTRY.register("etched_music_disc", () -> new Item(new Item.Properties().component(EtchedComponents.DISC_APPEARANCE, DiscAppearanceComponent.DEFAULT).stacksTo(1)));
